...
const rows = [
  createData("2019.11.18","test","일산동구","호텔","031-1234-5678","연동 완료"),
  createData("2019.11.18","test1","일산서구","모텔","031-2345-6789", "연동 대기중")
];
...
const headCells = [
  ...
  { id: 'fkind', numeric: false, disablePadding: false, label: '숙박 업태' },
        ...
        <FormControl className={classes.formControl}>
            ...
            IconComponent={() => (
              ...
              >
                ...
                <MenuItem value="fkind">숙박 업태</MenuItem>
